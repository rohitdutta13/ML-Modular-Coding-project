...
RAW_DATA_DIR_KEY = "raw_csv"
TRAIN_DATA_DIR_KEY = "train.csv"
TEST_DATA_DIR_KEY = "test.csv"

# Data transformation realted variable
...
# artifact | data_transformation | 1. processor -> processor.pkl and 2. transformation -> a.) train.csv and b.) test.csv
